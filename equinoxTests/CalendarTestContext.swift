...
final class CalendarTestContext {
    ...
    func event(start: Date, title: String = "Test meeting") -> DayEvent {
        DayEvent(
            id: "event-\(start.timeIntervalSinceReferenceDate)", eventIdentifier: "event",
            calendarItemIdentifier: "series", title: title, location: nil, notes: nil, url: nil,
            startDate: start, endDate: start.addingTimeInterval(3600),
            slotStartDate: start, slotEndDate: start.addingTimeInterval(3600),
            isEventAllDay: false, isSlotAllDay: false, joinURL: URL(string: "https://zoom.us/j/123"),
            ...
            isRecurring: true, allowsContentModifications: true, participationStatus: nil
        )
    }
}
